...
# https://docs.djangoproject.com/ja/1.9/howto/deployment/
#   checklist/#run-manage-py-check-deploy
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS',
                         default=['easypce.com', '.heroku.com'])
...
WEBPACK_LOADER['DEFAULT'].update({
    ...
    'CACHE': True,
    'STATS_FILE': ROOT('webpack-stats-prod.json'),
})
